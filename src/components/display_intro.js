...
const DisplayIntro = ({goFullScreen, handleClick, highscore: { table }}) => {
        return(
            <div className="bat-and-ball-intro-screen">
                <h1>BAT AND BALL!</h1>
                <div className="col-xs-hidden col-md-3"></div>
                <div className="col-xs-12 col-md-6">
                    <DisplayHighScoreTable highscore={table} />
                    ...
                    <div className="col-xs-6">
                        <button className="btn btn-primary btn-block full-screen" onClick={goFullScreen}><span>FULL SCREEN</span></button>
                    </div>
                    <div className="col-xs-6">
                        <button className="btn btn-success btn-block click-to-play" onClick={handleClick}><span>CLICK TO PLAY</span></button>
                    </div>
                </div>
                <div className="col-xs-hidden col-md-3"></div>
